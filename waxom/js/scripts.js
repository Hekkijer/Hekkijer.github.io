...
prev.addEventListener("mouseover", function(){
  prev.src="assets/img/header/hover-left-arrow.svg";
});
prev.addEventListener("mouseout", function(){
  prev.src="assets/img/header/slider-left-arrow.svg"
});

next.addEventListener("mouseover", function(){
  next.src="assets/img/header/hover-right-arrow.svg";
});
next.addEventListener("mouseout", function(){
  next.src="assets/img/header/slider-right-arrow.svg"
});
